...
cv2.line(image,(0,0),(511,511),(255,255,255),5)#image, start point, end point, color, thickness

cv2.rectangle(image,(384,0),(510,128),(0,255,0),3)# left and right cornet
cv2.ellipse(image,(256,256),(100,50),0,0,180,255,-1) #

pts = np.array([[10,5],[20,30],[70,20],[50,10]], np.int32) # poligons
