...
def convert_gray_to_binary(gray_image, adaptive, show):
    if adaptive: 
        ...
        _,binary_image = cv2.threshold(gray_image,127,255,cv2.THRESH_BINARY_INV) # threshold=127
    if show:
...
def main():
    ...
    binary_image = convert_gray_to_binary(gray_image, True, True) ##Second Flag to False
